...
var MvcGrid = (function () {
    ...
    MvcGrid.prototype = {
        ...
        lang: {
            text: {
                'contains': 'Arananı İçeren',
                'equals': 'Aranan ile eşleşen',
                'not-equals': 'Eşleşmeyenler',
                'starts-with': 'Aranan ile başlayan',
                'ends-with': 'Aranan ile biten'
            },
            number: {
                'equals': 'Aranan ile eşleşen',
                'not-equals': 'Aranan ile eşit olmayan',
                'less-than': 'Aranandan daha küçükler',
                'greater-than': 'Aranandan daha büyükler',
                'less-than-or-equal': 'Aranan ile eşit yada küçük',
                'greater-than-or-equal': 'Aranan ile eşit yada büyük'
            },
            date: {
                'equals': 'Aranan ile eşleşen',
                'not-equals': 'Aranan ile eşleşmeyen',
                'earlier-than': 'Aranan tarihten öncesi',
                'later-than': 'Aranan tarihten sonrası',
                'earlier-than-or-equal': 'Aranan tarih ile eşit veya önce',
                'later-than-or-equal': 'Aranan tarih ile eşit veya sonra'
            },
            enum: {
                'equals': 'Aranan ile eşleşen',
                'not-equals': 'Aranan ile eşleşmeyen'
